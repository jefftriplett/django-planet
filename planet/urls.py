...
urlpatterns = patterns('planet.views',
    url(r'^blogs/(?P<pk>\d+)/$', 'blog_detail', name='planet_blog_detail'),
    url(r'^blogs/$', 'blogs_list', name='planet_blog_list'),

    url(r'^feeds/(?P<pk>\d+)/tags/(?P<tag>.*)/$', 'feed_detail', name='planet_by_tag_feed_detail'),
    url(r'^feeds/(?P<pk>\d+)/$', 'feed_detail', name='planet_feed_detail'),
    url(r'^feeds/$', 'feeds_list', name='planet_feed_list'),

    url(r'^authors/(?P<pk>\d+)/tags/(?P<tag>.*)/$', 'author_detail', name='planet_by_tag_author_detail'),
    url(r'^authors/(?P<pk>\d+)/$', 'author_detail', name='planet_author_detail'),
    ...
    url(r'^posts/(?P<pk>\d+)/$', 'post_detail', name='planet_post_detail'),
