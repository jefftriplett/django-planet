...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Post', fields ['date_created']
        db.create_index('planet_post', ['date_created'])


    def backwards(self, orm):
        
        # Removing index on 'Post', fields ['date_created']
        db.delete_index('planet_post', ['date_created'])
